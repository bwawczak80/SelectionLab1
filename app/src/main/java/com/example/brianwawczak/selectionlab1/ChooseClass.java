   ...
   if (extras != null){
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (radioCheck(selectedTime1, selectedTime2, selectedTime3, selectedTime4)) {
                    ...
                    Toast.makeText(getApplicationContext(), "Time-slot conflict.", Toast.LENGTH_SHORT).show();
    ...
    public boolean radioCheck(int selectedTime1, int selectedTime2, int selectedTime3, int selectedTime4) {
        ...
        if ((selectedTime1 == R.id.rb2) && (selectedTime4 == R.id.rb7)) {
            rb2.setError("Time-slot conflict.");
            rb7.setError("Time-slot conflict.");
            return false;
        }

        if ((selectedTime1 == R.id.rb1) && (selectedTime2 == R.id.rb3)) {
            rb1.setError("Time-slot conflict.");
            rb3.setError("Time-slot conflict.");
            return false;
        }

        if ((selectedTime3 == R.id.rb5) && (selectedTime4 == R.id.rb8)) {
            rb5.setError("Time-slot conflict.");
            rb8.setError("Time-slot conflict.");
            return false;
        }
